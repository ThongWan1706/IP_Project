...
Shader "Tree Creator/URP/leaves mobile"
{
	Properties
	{
	...
	LOD 0
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				half temp_output_51_0 = ( ( input.positionOS.xyz.y * cos( ( ( ( ase_positionWS.x + ase_positionWS.z ) * WorldFrequency ) + ( ( _TimeParameters.x * 2 ) * WindSpeed ) ) ) ) * BendAmount );
				half4 appendResult52 = (half4(temp_output_51_0 , 0.0 , temp_output_51_0 , 0.0));
				half4 break60 = mul( appendResult52, GetObjectToWorldMatrix() );
				half4 appendResult58 = (half4(break60.x , 0 , break60.z , 0.0));
				half2 uv_MainTex = input.texcoord.xy * _MainTex_ST.xy + _MainTex_ST.zw;
				half2 appendResult78 = (half2(0.0 , ( uv_MainTex.x * sin( ( ( input.positionOS.xyz.x + 0.0 + ( _TimeParameters.x * _LocalWindSpeed ) ) / _LocalWindScale ) ) )));
				...
				float3 vertexValue = ( appendResult58 + half4( ( appendResult78 * _LocalWindIntensity ), 0.0 , 0.0 ) ).xyz;
						 ...
						 ) : SV_Target
			{
				...
				half4 tex2DNode11 = tex2D( _MainTex, uv_MainTex );
				
				half3 temp_cast_1 = (( ( _TranslucencyViewDependency * _ShadowStrength ) * 0.0 )).xxx;
	...
	Dependency "OptimizedShader"="Tree Creator/URP/leaves mobile"
	Dependency "BillboardShader"="Tree Creator/URP/leaves mobile"
	Dependency "OptimizedShader"="Tree Creator/URP/leaves mobile"
	Dependency "BillboardShader"="Tree Creator/URP/leaves mobile"
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;97;483.612,202.3718;Inherit;False;Property;_TranslucencyViewDependency;n1;5;0;Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;98;482.5289,288.1335;Inherit;False;Property;_ShadowStrength;n2;6;0;Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;104;1483.813,586.1253;Inherit;False;Property;_TranslucencyColor;Translucency Color;7;0;Create;False;0;0;0;False;0;False;0.7294118,0.8509805,0.4117647,1;0.7294118,0.8509805,0.4117647,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;11;1332.332,-1.229507;Inherit;True;Property;_MainTex;Albedo;4;0;Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;False;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;17;1385.899,218.5331;Inherit;False;Constant;_Shininess;Smoothness;6;0;Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=2755D4DACD0471DCBD1B672767E87958829929C2